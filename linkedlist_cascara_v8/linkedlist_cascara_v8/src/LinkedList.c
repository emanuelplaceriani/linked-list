 ...
 *
 */
void* ll_get(LinkedList* this, int index) //me devuelve el pElement
{
    void* returnAux = NULL;

    if(this!=NULL && index <=this->size)
    {
        returnAux=getNode(this,index); //MAL, DEVOLVER EL pElement
    }
    return returnAux;
}
...
int ll_set(LinkedList* this, int index,void* pElement)
{
    ...
    if(this!=NULL && pElement!=NULL && n!=NULL)
    {
        n->pElement=pElement;
        returnAux=0;
    }
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this!=NULL && n!=NULL)
    {
        anterior->pNextNode=n->pNextNode;
        n->pNextNode=NULL;
        free(n);
        returnAux=0;
    }
